...
@php
// Mapping Tipe Aset ke Nama File Form
$formView = match($type) {
...
@section('header', "Input $label Baru")
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Input {{ $label }} Baru</h1>
            <p class="text-sm text-gray-500">Form khusus untuk menambahkan data {{ strtolower($label) }}.</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-lg p-8">
        <form action="{{ route('admin.assets.store') }}" method="POST" class="space-y-6">
            ...
            {{-- Input Hidden untuk Tipe (PENTING) --}}
