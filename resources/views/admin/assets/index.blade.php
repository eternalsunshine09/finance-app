...
<div x-data="{ 
    ...
    <div class="flex flex-col md:flex-row justify-between items-end gap-4 mb-6">
        ...
        <div class="flex items-center gap-3">
            ...
            {{-- Tombol Tambah (Membawa Parameter Type) --}}
            ...
            <table class="w-full text-left border-collapse">
                <thead
                    ...
                    <tr>
                        ...
                        {{-- Tampilkan Kolom Kategori HANYA jika Reksadana (untuk lihat RDPU/RDS) --}}
                        @if($type == 'Mutual Fund')
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    ...
                    <tr class="hover:bg-gray-50 transition group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                <div
                                    ...
                                    @else {{ substr($asset->symbol, 0, 2) }} @endif
                                </div>
                                <div>
                        ...
                        <td class="px-6 py-4">
                            <span
                                class="px-2.5 py-1 rounded-md text-[10px] font-bold border bg-green-50 text-green-700 border-green-200">
                                {{ $asset->subtype ?? '-' }}
                            </span>
                        </td>
                        @endif
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2 group/edit">
                                <span class="font-mono font-bold text-gray-900">
                                    {{ $asset->type == 'Crypto' ? '$' : 'Rp' }}
                                    {{ number_format($asset->current_price, $asset->type == 'Crypto' ? 2 : 0, ',', '.') }}
                                </span>
                                <button
    ...
    {{-- MODAL DIBAWAH SINI TETAP SAMA SEPERTI SEBELUMNYA --}}
    {{-- ... (Copy paste modal edit harga disini) ... --}}
</div>
@endsection